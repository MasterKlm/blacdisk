...
import { getValidAccessToken, saveTokens } from "./sessions.js";
import chalk from 'chalk';
import { sleep } from "./utils.js";
export async function discoverEndpoints(issuer) {
...
export async function clerkCliLogin(clientId, issuer) {
...
export async function requestCard(status) {
    console.log(chalk.yellow('Your free tokens are used up. Add a payment method to continue. Opening browser...'));
    const clerkUserId = await getCurrentUserId();
    const checkoutUrl = `https://www.blacdisk.com/api/checkout?products=${process.env.POLAR_PRODUCT_ID}` +
